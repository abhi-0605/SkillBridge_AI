    ...
    return (
      <div className="space-y-8">
        ...
        <motion.div
          ...
          className='relative overflow-hidden rounded-3xl border border-border bg-white p-10 text-center shadow-sm'
        >
          <div className='pointer-events-none absolute -right-16 -top-16 h-64 w-64 rounded-full bg-indigo-100/60' />
          <div className='pointer-events-none absolute -bottom-16 left-1/3 h-56 w-56 rounded-full bg-indigo-100/40' />
          ...
          <div className='relative'>
            ...
            <h2 className='mt-5 text-xl font-semibold text-foreground'>Run your first analysis</h2>
        ...
        <div className='grid gap-4 sm:grid-cols-3'>
          {[
            ...
            <div key={title} className='group rounded-2xl border border-border bg-white p-5 shadow-sm transition-all hover:border-primary/40 hover:shadow-lg'>
    ...
    <div className="space-y-8">
      ...
      <div className='grid gap-4 sm:grid-cols-3'>
        <div className='rounded-2xl border border-border bg-white p-5 shadow-sm'>
          ...
          <div className='mt-4 text-3xl font-bold text-foreground'>{totalAnalyses}</div>
        ...
        <div className='rounded-2xl border border-border bg-white p-5 shadow-sm'>
          ...
          <div className='mt-4 text-3xl font-bold text-foreground'>{avgScore ?? '—'}</div>
        ...
        <div className='rounded-2xl border border-border bg-white p-5 shadow-sm'>
          ...
          <div className='mt-4 text-3xl font-bold text-foreground'>{bestScore ?? '—'}</div>
        ...
        <div className='divide-y divide-border'>
          {recent.map((a) => (
            <Link
              ...
              className='flex cursor-pointer items-center gap-4 py-3 transition hover:bg-gray-50 rounded-lg px-2 -mx-2'
            >
