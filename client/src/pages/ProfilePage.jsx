...
const ProfilePage = () => {
    ...
    return (
        <div className='space-y-8' >
            <div>
                <p className='text-xs uppercase tracking-[0.3em] text-primary font-medium' >Profile</p>
                <h1 className='mt-2 text-3xl font-bold text-foreground md:text-4xl' >Account</h1>
            </div>
            ...
            <div className='grid gap-6 lg:grid-cols-3' >
                <div className='rounded-2xl border border-border bg-white p-6 text-center shadow-sm' >
                    ...
                    <div className='mt-5 grid grid-cols-2 gap-3 text-center text-xs' >
                        <div className='rounded-xl border border-border bg-gray-50 p-3' >
                            <div className='text-lg font-semibold text-foreground' >{loading ? '-' : totalAnalyses}</div>
                            <div className='mt-1 text-[10px] uppercase tracking-wider text-muted-foreground' >Analyses</div>
                        </div>

                        <div className='rounded-xl border border-border bg-gray-50 p-3' >
                            <div className='text-lg font-semibold text-foreground' >{loading ? '-' : bestScore ?? '—'}</div>
                ...
                <div className='rounded-2xl border border-border bg-white p-6 shadow-sm lg:col-span-2' >
                    <h2 className='mb-4 font-semibold text-foreground' >Account details</h2>
    ...
    return (
        <div className='flex items-center gap-3 rounded-xl border border-border bg-gray-50 px-4 py-3' >
            ...
            <div className='min-w-0 flex-1' >
                ...
                <div className='truncate text-sm font-medium capitalize text-foreground' >{value || '-'}</div>
            </div>
        </div>
    )
}
